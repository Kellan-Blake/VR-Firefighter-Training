...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Action_Boolean p_default_Thumbstick;
        
        private static SteamVR_Action_Vector2 p_default_ThumbstickDir;
        
        private static SteamVR_Action_Boolean p_default_UseInteraction;
        
        private static SteamVR_Action_Boolean p_default_SecondaryInteraction;
        ...
        public static SteamVR_Action_Boolean default_Thumbstick
        {
            get
            {
                return SteamVR_Actions.p_default_Thumbstick.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        
        public static SteamVR_Action_Vector2 default_ThumbstickDir
        {
            get
            {
                return SteamVR_Actions.p_default_ThumbstickDir.GetCopy<SteamVR_Action_Vector2>();
            }
        }
        
        public static SteamVR_Action_Boolean default_UseInteraction
        {
            get
            {
                return SteamVR_Actions.p_default_UseInteraction.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        
        public static SteamVR_Action_Boolean default_SecondaryInteraction
        {
            get
            {
                return SteamVR_Actions.p_default_SecondaryInteraction.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        ...
        private static void InitializeActionArrays()
        {
            Valve.VR.SteamVR_Input.actions = new Valve.VR.SteamVR_Action[] {
                    ...
                    SteamVR_Actions.default_ThumbstickDir,
                    SteamVR_Actions.default_UseInteraction,
                    SteamVR_Actions.default_SecondaryInteraction,
        ...
        private static void PreInitActions()
        {
            ...
            SteamVR_Actions.p_default_Thumbstick = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/default/in/Thumbstick")));
            SteamVR_Actions.p_default_ThumbstickDir = ((SteamVR_Action_Vector2)(SteamVR_Action.Create<SteamVR_Action_Vector2>("/actions/default/in/ThumbstickDir")));
            SteamVR_Actions.p_default_UseInteraction = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/default/in/UseInteraction")));
            SteamVR_Actions.p_default_SecondaryInteraction = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/default/in/SecondaryInteraction")));
